 ...
 */
export type ToastPositions = "top-left" | "top-center" | "top-right" | "bottom-left" | "bottom-right" | "bottom-center";
/**
 * ## Toast Types
 *
 ...
 */
export type ToastAnimations = "popdown" | "popup" | "fade-in" | "slide-up" | "slide-down" | "slide-left" | "slide-right";
/**
 * ## Toast Colors
 *
...
interface Toast {
    (props: ToastProps, options?: Partial<ToastOptions>, type?: ToastTypes): ToastReturn;
    /**
     * ## Success Toast
     *
     ...
     * - type = "success"
     */
    success: (props: ToastProps, options?: Partial<ToastOptions>) => ToastReturn;
    /**
     * ## Error Toast
     *
     ...
     * - type = "loading"
     */
    loading: (props: ToastProps, options?: Partial<ToastOptions>) => ToastReturn;
    /**
     * ## Toast Dismiss
     *
