...
export type ToastTypes = "neutral" | "success" | "error" | "info" | "warn" | "loading";
export type LoadingIconTypes = "normal" | "eclipse" | "broken-straight" | "broken-rounded" | "broken-flat";
...
export type ToastListener = (toast: Toast, type: "add" | "remove" | "animate-out") => void;
...
export interface StoreInterface {
    ...
    create(_props: ToastProps, _options?: ToastOptions, _type?: ToastTypes): ReturnValue;
    /** Removes a toast */
...
interface MainToast {
    default(props: ToastProps, options?: ToastOptions, type?: ToastTypes): ReturnValue;
    /** ## Toast success
     ...
     *  error | response data
     */
    promise<T, K>(callback: (...args: T[]) => Promise<K>, ...args: T[]): Promise<K>;
    /** ## Toast dismiss
     *  Removes a toast.
     */
